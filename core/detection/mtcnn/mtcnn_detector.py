...
import cv2
import numpy as np
from .models import mtcnn_model as mtcnn
from pybaseutils import image_utils, file_utils


class MTCNNDetector():
    def __init__(self, input_size: list = [320, None], conf_thresh=[0.75, 0.85, 0.95], iou_thresh=[0.7, 0.7, 0.7]):
        self.input_size = input_size
        min_face_size = 20.0
        self.detecror = mtcnn.MTCNN(min_face_size, conf_thresh, iou_thresh)
